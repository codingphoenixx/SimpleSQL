 ...
 */
public class UpdateQueryProvider extends UpdateingQueryProvider {
    ...
    private Order order;
    private Limit limit;
    private RunnableAction<QueryResult<UpdateQueryProvider>> actionAfterQuery;
     ...
     * @return the current instance of {@code UpdateQueryProvider} for method chaining.
     */
    public UpdateQueryProvider actionAfterQuery(RunnableAction<QueryResult<UpdateQueryProvider>> actionAfterQuery) {
        this.actionAfterQuery = actionAfterQuery;
        return this;
    }

    @Override
    public RunnableAction<QueryResult<UpdateQueryProvider>> actionAfterQuery() {
